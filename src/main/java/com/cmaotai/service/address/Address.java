...
public class Address {
    ...
    static {
        ...
        address2.setShipTo(getCallName());
        ...
        address3.setShipTo(getCallName());
        ...
        address4.setShipTo(getCallName());
        ...
        address5.setShipTo(getCallName());
        ...
        address6.setShipTo(getCallName());
        ...
        address7.setShipTo(getCallName());
        ...
        address8.setShipTo(getCallName());
        ...
        address9.setShipTo(getCallName());
        ...
        address10.setShipTo(getCallName());

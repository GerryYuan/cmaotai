...
public class GUIMain extends JFrame {
    ...
    public GUIMain() {
        ...
        outputUI();
        startQty.addFocusListener(new FocusAdapter() {
            @Override
            public void focusLost(FocusEvent e) {
                if (NumberUtils.parseNumber(startQty.getText(), Integer.class) == null) {
                    show("起始瓶数不能为空！");
                    startQty.requestFocus();
                }
            }
        });
        endQty.addFocusListener(new FocusAdapter() {
            @Override
            public void focusLost(FocusEvent e) {
                if (NumberUtils.parseNumber(endQty.getText(), Integer.class) == null) {
                    show("起结止瓶数不能为空！");
                    endQty.requestFocus();
                }
            }
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        order.setText("查询订单");
        panel1.add(order, new GridConstraints(3, 3, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_NONE,
            GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW,
            GridConstraints.SIZEPOLICY_FIXED, null, null, null, 5, false));
        final JLabel label3 = new JLabel();
        label3.setText("下单时间间隔（分钟）");
        ...
        label4.setText("下单瓶数");
        panel1.add(label4, new GridConstraints(1, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_NONE,
            GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        endQty.setText("6");
        panel1.add(endQty, new GridConstraints(1, 3, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL,
            GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null,
            0, false));
        final JLabel label5 = new JLabel();
        label5.setText("到");
        panel1.add(label5, new GridConstraints(1, 2, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_NONE,
            GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));

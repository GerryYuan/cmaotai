...
public class GUIMain extends JFrame {
    ...
    public GUIMain() {
        ...
        outputUI();
        startQty.addFocusListener(new FocusListener() {
            @Override
            public void focusGained(FocusEvent e) {
            }
            ...
            @Override
            public void focusLost(FocusEvent e) {
                if (Strings.isBlank(startQty.getText())) {
                    show("输入必须是数字！");
                }
            }
        });
        endQty.addFocusListener(new FocusListener() {
            ...
            @Override
            public void focusLost(FocusEvent e) {
                if (Strings.isBlank(endQty.getText())) {
                    show("输入必须是数字！");
                }
            }
        });
